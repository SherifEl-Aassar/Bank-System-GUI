                ...
                if (reader.GetString(1) == Program.logged_in.Check[Program.logged_in.AccountIndex].get_ID())
                {
                    if (OverdraftFee > 0)
                    {
                        ...
                        if (OverdraftFee < value)
                        {
                            ...
                            Program.logged_in.Check[Program.logged_in.AccountIndex].set_Balance(Balance);
                            Program.logged_in.Check[Program.logged_in.AccountIndex].set_overdaraft(0);
                        ...
                        {
                            Program.logged_in.Check[Program.logged_in.AccountIndex].set_Balance(0);
                            Program.logged_in.Check[Program.logged_in.AccountIndex].set_overdaraft(0);
                        ...
                        else
                        {
                            ...
                            Program.logged_in.Check[Program.logged_in.AccountIndex].set_Balance(Balance);
                            Program.logged_in.Check[Program.logged_in.AccountIndex].set_overdaraft(OverdraftFee);
