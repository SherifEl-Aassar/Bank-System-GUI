    ...
    public partial class LoginForm : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            while (reader.Read())
            {
                ...
                {
                    Program.logged_in.set_ID ( reader.GetString(0));


                    Program.logged_in.set_FirstName(reader.GetString(1));

                    Program.logged_in.set_LastName(reader.GetString(2));

                    Program.logged_in.set_Pass(reader.GetString(3));
                    ...
                    while (reader2.Read())
                    {
                        if (reader2.GetString(0) == Program.logged_in.get_ID())
                        {
